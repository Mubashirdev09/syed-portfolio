 ...
 * - Integrations: MDX for rich content, Sitemap for SEO, Mermaid for diagrams
 ...
 *
 * @see [https://astro.build/config](https://astro.build/config)
 */
...
export default defineConfig({
   ...
   * Astro integrations
   *
   * - Mermaid: Renders Mermaid diagrams inside Markdown/MDX
   ...
   *
   * Important:
   * Mermaid must be excluded from syntax highlighting so diagram blocks
   * are rendered by the Mermaid integration instead of being treated as code.
   */
  markdown: {
    syntaxHighlight: {
